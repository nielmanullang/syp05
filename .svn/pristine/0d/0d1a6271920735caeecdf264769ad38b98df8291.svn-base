...
class SiteController extends Controller {
    ...
    public function actionIndex() {
        ...
        //$pengumuman = new \yii\data\SqlDataProvider([
        //    'sql'=>'select t_m_pengumuman.id from t_m_pengumuman join t_m_pengguna on t_m_pengumuman.id_pengguna = t_m_pengguna.id ',
        //'pagination'=>['pageSize'=>4],]);

        $searchModelBuku = new \common\models\MasterBukuSearch();
        $dataProviderBuku = new ActiveDataProvider([
        ...
        $searchModelArtikel = new \common\models\MasterArtikelSearch();
